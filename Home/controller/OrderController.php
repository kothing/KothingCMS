	...
	function pay(){
		if($this->frparam('go')){
			...
			if($this->webconf['paytype']==1){
				//检查Kothing平台配置
				if(!$this->webconf['kothing_mchid'] || !$this->webconf['kothing_appid'] || !$this->webconf['kothing_key'] || !$this->webconf['kothing_pay_url']){
				...
				$order['mchid'] = $this->webconf['kothing_mchid'];
				$order['appid'] = $this->webconf['kothing_appid'];
				$order['secretkey'] = $this->webconf['kothing_key'];
				...
				$url = $this->webconf['kothing_pay_url'].'/Pay/onlinePay';
				$this->order = $order;
				$this->url = $url;
			...
			if($this->webconf['paytype']==0 && $order['ptype']==1){
				...
				$controller = $this->frparam('controller',1);
