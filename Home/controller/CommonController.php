...
class CommonController extends Controller
{
	...
	function vercode(){
		...
		$imagecode=new \Imagecode($w,$h,$n,$name,APP_PATH."Framework/Extend/AdobeGothicStd-Bold.ttf");
		$imagecode->imageout();
		...
		<script type="text/javascript">
			$(document).ready(function(){
			  $("#upload_input_litpic_'.$rand.'").change(function(){
			    var form=document.getElementById("kothingform");
