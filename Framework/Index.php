...
class Framework
{
    ...
    public function route()
    {
       ...
       // $url = urldecode($url);
		...
		if (!class_exists($controller) || !method_exists($controller, $actionName)) {
            ...
            if($controllerName=='Home' && $actionName=='kothing'){
            	if(method_exists(APP_HOME.'\\plugins\\HomeController', 'kothing')){
    ...
    {
        return [
            'Framework\lib\Controller' => CORE_PATH . '/lib/Controller.php',
            'Framework\lib\Model' => CORE_PATH . '/lib/Model.php',
            'Framework\lib\View' => CORE_PATH . '/lib/View.php',
            'Framework\db\DBholder' => CORE_PATH . '/db/DBholder.php',
