...
function send_mail($send_mail,$password,$send_name,$to_mail,$title,$body,$email_ext=''){
	...
	require APP_PATH.'Framework/Extend/PHPMailer/PHPMailerAutoload.php';
	require_once(APP_PATH.'Framework/Extend/PHPMailer/class.phpmailer.php');
	require_once(APP_PATH."Framework/Extend/PHPMailer/class.smtp.php");
